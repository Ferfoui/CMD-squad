...
# Les noms des tuiles
OBSTACLES_TILE_TYPES = ['dirt_default', 'dirt_default_right_border', 'dirt_default_left_border', 'dirt_default_down_border', 'dirt_default_down_left_corner', 'dirt_default_down_right_corner', 'grass_default', 'grass_default_right_border', 'grass_default_left_border', 'sand','sand_default_top_border','sand_default_top_left_corner']
ENTITY_TILE_TYPES = []
